...
import { checkout, createOrderFromBooking, getMyOrder, pay, verifyPayment, type Order, type PaymentIntent } from '../../../api/orders';
    ...
    (async () => {
      ...
      try {
        ...
        if (state.orderId) {
          ...
          currentOrder = (await createOrderFromBooking(token, state.bookingId)).data;
        } else {
        ...
        <div className="checkout-page__layout">
          <main className="checkout-page__form">
            <section aria-labelledby="step-pay-heading">
              <h2 id="step-pay-heading" className="checkout-form__heading">Payment Details</h2>
