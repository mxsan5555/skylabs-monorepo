...
@Component({
  selector: 'md-health-docs-master',
  standalone: true,
  imports: [AdminPage],
  templateUrl: './health-docs.html',
  styleUrl: '../masters.css',
  schemas: [CUSTOM_ELEMENTS_SCHEMA]
})
export class HealthDocsMaster {
  readonly options = signal<MasterOption[]>([
    { id: 1, name: 'Medical Fitness Certificate', status: 'Active' },
    { id: 2, name: 'Eye Test Report', status: 'Active' },
    { id: 3, name: 'Blood Report', status: 'Active' },
    { id: 4, name: 'Drug Test Report', status: 'Active' }
  ]);
