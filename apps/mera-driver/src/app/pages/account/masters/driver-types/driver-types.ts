...
@Component({
  selector: 'md-driver-types-master',
  standalone: true,
  imports: [AdminPage],
  templateUrl: './driver-types.html',
  styleUrl: '../masters.css',
  schemas: [CUSTOM_ELEMENTS_SCHEMA]
})
export class DriverTypesMaster {
  readonly options = signal<MasterOption[]>([
    { id: 1, name: 'Personal driver', status: 'Active' },
    { id: 2, name: 'Car Driver', status: 'Active' },
    { id: 3, name: 'Bike Rider', status: 'Active' },
    { id: 4, name: 'Ambulance Driver', status: 'Active' },
    { id: 5, name: 'Construction Vehicle Driver', status: 'Active' }
  ]);
